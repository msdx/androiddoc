...
var GOOGLE_RESOURCES = [
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"This document describes the Google Cloud Messaging (GCM) HTTP connection server. Connection servers are the Google-provided servers that take messages from the 3rd-party application server and sending them to the device. See the Server Reference for a…",
      ...
      {
        "title":"Implementing GCM Client on Android",
        "titleFriendly":"",
        "summary":"A Google Cloud Messaging (GCM) Android client is a GCM-enabled app that runs on an Android device. To write your client code, we recommend that you use the GoogleCloudMessaging API. Here are the requirements for running a GCM Android client: A full GCM…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"This document provides a reference for the syntax used to pass messages back and forth in GCM. These messages fall into the following broad categories: The following sections describe the basic requirements for sending messages. This is the message that…",
        "url":"google/gcm/server-ref.html",
        "group":"",
        "keywords": [],
        "tags": [],
        "image":"",
      ...
      }, 
      {
        "title":"Overview",
        "titleFriendly":"",
        "summary":"Google Cloud Messaging (GCM) is a free service that enables developers to send downstream messages (from servers to GCM-enabled client apps), and upstream messages (from the GCM-enabled client apps to servers). This could be a lightweight message telling…",
      ...
      }, 
      {
        ...
        "titleFriendly":"",
        "summary":"The server side of Google Cloud Messaging (GCM) consists of two components: A full GCM implementation requires both a client implementation and a server implementation. For more information about implementing the client side, see Implementing GCM Client…",
...
var DESIGN_BY_TAG = {
    ...
    "toast":[22,48,52], 
    "notification":[22,48], 
    "input":[24,32,39,55,58], 
    "button":[24,58,62], 
    "branding":[25], 
    "logo":[25], 
    "actionmode":[30], 
    "navigation":[30,32,33,36,47,49,50,53], 
    "contextual":[30], 
    "accessibility":[32], 
    "viewpager":[33,53], 
    "support":[34], 
...
var DISTRIBUTE_BY_TAG = {
    "users":[2,3,4,5,6,7], 
    "ads":[2,28], 
    "analytics":[2,8,9,11,12,13,14,32], 
    "listing":[4], 
    "googleplay":[4,16,19,29,42,44,45,62], 
    "disttools":[16,17,21,22], 
    "promoting":[16,17,20], 
    "deviceart":[16,17], 
    "marketing":[16,17], 
    "brand":[18], 
...
var GUIDE_BY_TAG = {
    ...
    "soundpool":[25], 
    "audiomanager":[25], 
    "mediarouteprovider":[28], 
    "mediacontrolintent":[28], 
    "audio":[30,170], 
    "video":[30,33,170], 
    "adaptive":[30], 
    "streaming":[30], 
    ...
    "external":[68], 
    "database":[69], 
    "sharedpreferences":[69], 
    "valueanimator":[77], 
    "objectanimator":[77], 
    "layouttransition":[77], 
    "viewpropertyanimator":[77], 
    "games":[78], 
    "location":[80], 
    "sensors":[80], 
    "sensorevent":[83,84], 
    ...
    "homescreen":[88], 
    "launcher":[88], 
    "hostcardemulation":[90], 
    "hce":[90], 
    "hostapduservice":[90], 
    "offhostapduservice":[90], 
    "tapandpay":[90], 
    "wireless":[97,98,100], 
    "wifip2pmanager":[97], 
    "wi-fidirect":[97], 
    ...
    "telephony":[99], 
    "searchview":[101], 
    "searchrecentsuggestions":[104], 
    "searchrecentsuggestionsprovider":[104,105], 
    "ime":[107], 
    "keyboard":[107], 
    "inputmethodservice":[107], 
    "input":[108,109], 
    "spellcheckerservice":[108], 
    "clipboardmanager":[109], 
    "clipdata":[109,121], 
    "view":[114,133], 
    "viewgroup":[114], 
    "alertdialog":[115], 
    ...
    "radiogroup":[130], 
    "preference":[132], 
    "preferenceactivity":[132], 
    "preferencefragment":[132], 
    "actionbar":[139], 
    "menu":[139], 
    "tabs":[139], 
    "listview":[142], 
...
var TRAINING_BY_TAG = {
    "intents":[0,36,37,38,39,50], 
    "share":[0,7,292], 
    "fileprovider":[7], 
    "print":[11], 
    "navigation":[11,63,134,193], 
    "gesturedetector":[11,134], 
    "scroller":[11,134], 
    "gamecontroller":[14], 
    "datastorage":[27,28,29,30], 
    "fragments":[31,32,34,35,78], 
    "supportlibrary":[33], 
    "layouts":[40,43], 
    "resources":[40,41], 
    "screens":[40], 
    ...
    "localizing":[41], 
    "styles":[42], 
    "activitylifecycle":[44,45,46,47,48], 
    "sdktools":[49], 
    "projectsetup":[51], 
    "ui":[52,286], 
    "emulator":[53], 
    "network":[54,90,124,260,261,315], 
    "wireless":[54,90,124], 
    "actionbar":[58,59,60,61,62], 
    "":[73], 
    "tablet":[78], 
    "tv":[78,172,173,174,175,178,179,180,182,183,186,187,188,189], 
    "multiplescreens":[79,308], 
    "cloud":[82,244], 
    "wifi":[90], 
    "notifications":[93,94,95,96,97,98,208,209,210,211,212], 
    "threadpool":[99], 
    "runnable":[99], 
    "widgets":[107,286], 
    "support":[107,267], 
    ...
    "geofence":[152], 
    "geofencing":[152], 
    "activityrecognition":[152], 
    "activitydetection":[152], 
    "gps":[152,263], 
    "opengl":[160], 
    "graphics":[160,282], 
    "privacy":[167,312], 
    ...
    "tabs":[194], 
    "upnavigation":[195], 
    "wear":[202,203,204,205,206,207,209], 
    "auto":[234,235,237], 
    "car":[234,235,237], 
    "automotive":[234,235,237], 
    "testing":[246], 
    "searchview":[253], 
    "database":[253], 
    "ndk":[257,258], 
